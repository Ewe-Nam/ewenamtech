...
const SERVICES = [
  {
    ...
    lead: true,
    description:
      "LAN/WAN setup and troubleshooting, switch installation and configuration, TCP/IP addressing, connectivity testing, and network security fundamentals — plus topology design and simulation in GNS3, VyOS, MikroTik, and Cisco environments.",
  },
  {
    icon: ServerCog,
...
export default function WhatWeDoSection() {
  return (
    <section id="services" className="border-t border-sky-200/15 py-24">
            ...
            <div
              ...
              className={`rounded-3xl border p-7 backdrop-blur-xl transition-colors ${
                s.lead
                  ...
                  : "border-sky-200/15 bg-sky-100/10 hover:border-sky-200/35"
              }`}
            >
              <div
                className={`mb-5 flex h-12 w-12 items-center justify-center rounded-2xl ring-1 ${
                  s.lead ? "bg-cyan-400/15 ring-cyan-400/30" : "bg-sky-200/15 ring-sky-200/30"
                }`}
              >
              ...
              <p className="text-sm leading-relaxed text-sky-100/70">{s.description}</p>
              {s.href && (
                <a
                  href={s.href}
        ...
        <div className="relative overflow-hidden rounded-3xl border border-amber-300/25 bg-amber-300/[0.05] p-8 backdrop-blur-xl">
          <div className="flex flex-col gap-6 sm:flex-row sm:items-start">
            ...
            <div>
              ...
              <p className="mb-3 max-w-3xl text-sm leading-relaxed text-sky-100/70">
              ...
              <p className="max-w-3xl text-sm leading-relaxed text-sky-200/60">
